...
*[Image placeholder: Example trace visualization showing agent execution flow]*
...
Transform your AI agents from black boxes to fully observable systems:

<Steps>
### Add Tracing to Your Agent
Choose from decorators, wrappers, or manual instrumentation

### Run Your Agent
Execute normally - tracing happens automatically in the background

### View Insights
Access detailed traces, performance metrics, and optimization opportunities
</Steps>
