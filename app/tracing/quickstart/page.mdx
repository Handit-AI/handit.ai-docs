...
*[Image placeholder: Screenshot of Handit.ai Dashboard showing the "My Agents" section with the "Create New Agent" button highlighted]*

### Step 2: Choose Your Creation Method

You have two powerful options to create your agent:

<Tabs items={['🤖 AI-Powered Creation', '🎨 Visual Builder']}>
<Tabs.Tab>
...
*[Image placeholder: Screenshot of the JSON upload interface showing the file upload area and "Upload & Analyze" button]*
...
*[Image placeholder: Screenshot showing the AI analysis results with the normalized agent structure and confirmation dialog]*
...
*[Image placeholder: Screenshot of the visual builder interface showing the drag-and-drop canvas with component library on the left and a sample agent workflow]*
...
*[Image placeholder: Screenshot of a node configuration panel showing the form fields for configuring an LLM node with model selection, purpose, and parameters]*
...
*[Image placeholder: Screenshot showing the completed agent overview page with the "Download Config" button and a preview of the generated configuration]*
  ...
  "nodes": [
    {
      ...
      "slug": "intent-classifier",             // 🔑 This slug is what you'll use in code
    ...
    {
      "name": "Knowledge Search",
      "slug": "knowledge-search",              // 🔑 This slug is what you'll use in code
      "type": "tool",
    ...
    },
    {
      ...
      "slug": "response-generator",            // 🔑 This slug is what you'll use in code
      "type": "model",
...
*[Image placeholder: Screenshot of the Handit.ai Dashboard showing the Settings menu expanded with "Integrations" highlighted]*
...
*[Image placeholder: Screenshot of the Integrations page showing the SDK Integration section with the integration token field and copy button]*
...
- **`trace_agent_node_func_sync`** - One-off sync function calls you need to trace  
...
**Step 2:** Create your `handit.config.json` file for this example:
