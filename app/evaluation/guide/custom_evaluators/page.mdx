...
*[Image placeholder: Custom evaluator creation form]*
...
*[Image placeholder: Model token selection dropdown]*

**3. Create Evaluation Prompt**

This is where you define your evaluation criteria and instructions for the judge model:
...
*[Image placeholder: Evaluation prompt text area with example prompt]*

**4. Save Evaluator**
- Review your configuration
- Click **Save** to create the evaluator

*[Image placeholder: Save evaluator button and confirmation]*
