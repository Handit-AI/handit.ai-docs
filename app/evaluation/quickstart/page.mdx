...
*[Image placeholder: Model Tokens page with "Add New Token" button highlighted]*
...
*[Image placeholder: Evaluation Suite main page with "Create New Evaluator" button]*
...
*[Image placeholder: Evaluator creation form showing the completeness evaluator setup]*
...
*[Image placeholder: Second evaluator creation showing hallucination detection setup]*
...
*[Image placeholder: Third evaluator showing format compliance setup]*
...
*[Image placeholder: Tracing nodes page showing available LLM nodes]*
...
*[Image placeholder: LLM node page with Evaluation tab and "Add Evaluator" button]*
...
*[Image placeholder: Evaluator association configuration showing multiple evaluators being added]*
...
*[Image placeholder: Final configuration summary showing all evaluators associated]*
...
*[Image placeholder: Live evaluation dashboard showing real-time results]*
...
*[Image placeholder: Analytics dashboard showing trends for different evaluators]*

### Sample Result Display

*[Image placeholder: Detailed evaluation result showing scores for each aspect]*
...
*[Image placeholder: Examples of different evaluator types in the platform]*
...
Ready to dive deeper into evaluation? Learn more about advanced evaluation techniques and best practices:

- [LLM as Judges - Advanced Evaluation Techniques](/evaluation/llm-as-judges)
