...
*[Image placeholder: Optimization settings page with token selection interface]*

**2. Configure Your Optimization Model**

Select or configure your optimization model:

*[Image placeholder: Optimization token configuration form]*
...
*[Image placeholder: Agent Performance dashboard showing optimization results]*
...
*[Image placeholder: Release Hub showing prompt metrics per LLM node]*
...
*[Image placeholder: Detailed prompt comparison in Release Hub]*
...
*[Image placeholder: Release Hub main interface showing recommended optimizations]*
...
*[Image placeholder: Marking prompt as production in Release Hub]*
...
*[Image placeholder: Code examples showing SDK integration]*
...
*[Image placeholder: Prompt performance monitoring in Agent Performance dashboard]*
