...
*[Image placeholder: Release Hub workflow from nodes to selection]*
...
*[Image placeholder: Navigation to Release Hub]*
...
*[Image placeholder: Release Hub main interface showing LLM nodes]*
...
*[Image placeholder: Metrics comparison interface]*
...
*[Image placeholder: Text comparison showing prompt differences]*
...
*[Image placeholder: Production marking confirmation interface]*
