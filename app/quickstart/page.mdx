...
*[Image placeholder: Integration token in dashboard settings]*
...
*[Image placeholder: Agent creation interface]*
...
*[Image placeholder: Model token configuration]*
...
1. Go to **Tracing** → **Nodes**
2. Select your LLM node (e.g., "response-generator")
3. Navigate to **Evaluation** tab
4. Add your evaluators with sampling percentages:
   - Completeness: 10%
   - Accuracy: 15%
   - Format: 5%

*[Image placeholder: Evaluator association interface]*
...
*[Image placeholder: Evaluation results dashboard]*
...
1. Go to **Optimization** → **Settings** → **Model Tokens**
2. Add or select optimization model tokens
3. Self-improving AI automatically activates once configured

*[Image placeholder: Optimization model configuration]*
...
*[Image placeholder: Release Hub with optimization recommendations]*
...
Now that you have the complete system running, explore advanced features:

### Deep Dive Guides
- **[Advanced Tracing](/tracing/quickstart)** - Comprehensive observability features
- **[Sophisticated Evaluation](/evaluation/quickstart)** - Advanced evaluation techniques  
- **[Optimization & CI/CD](/optimization/quickstart)** - Advanced deployment strategies

### Feature Exploration
- **[Background A/B Testing](/optimization/optimization_features/ab_testing)** - Understand the testing methodology
- **[Release Hub](/optimization/guide/release_hub)** - Advanced prompt management
- **[SDK Integration](/optimization/guide/sdk_integration)** - Production integration patterns

### Get Started Today
- **[Visit Handit.ai](https://beta.handit.ai)** to begin your AI transformation
- Join our [Discord community](https://discord.gg/handit-ai) for support
- Check out [Support](/support) for additional help
